...
// let parmentTd = document.querySelectorAll('#paymentTable tbody tr td');
// let totalBillAmount = 0;
// let totalTipAmount = 0;
// let totalTipPercent = 0;
// if (parmentTd.length !== 0) {
//     for (let i = 0; i < parmentTd.length; i + 3) {
//         totalBillAmount = totalBillAmount + parmentTd[i];
//         totalTipAmount = totalTipAmount + parmentTd[i + 1];
//         totalTipPercent = totalTipPercent + parmentTd[i + 2];
//         console.log(parmentTd[i]);
//         console.log(parmentTd[i + 1]);
//         console.log(parmentTd[i + 2]);
//     }
// }

// summaryTds[0].innerHTML = '$' + totalBillAmount;
// summaryTds[1].innerHTML = '$' + totalTipAmount;
// summaryTds[2].innerHTML = Math.round(totalTipPercent) + '%';
